...
namespace Videojuego.Clase_base
{
    internal class Videojuegos
    {
        ...
        internal class VideoJuego
        {
            ...
            public void mostrardetallesAccion()
            {
                Console.WriteLine($"titulo:{titulo},desarroladora:{desarrolladora},calificacion:{calificacion},año de lanzamiento:{AnioLanzamiento},jugando {jugando}");
            }
